...
const Header = () => {
              ...
              >
                ...
                <li>
                  <button
                    ...
                    className={`btn-md text-lg ${
                      Dark ? "bg-slate-800 hover:text-white" : "bg-[#75d5e3]"
  ...
  return (
    <div
      className={`fixed top-0 z-50 left-0 right-0 shadow-xl ${
    ...
    >
      <div className="navbar bg-none  md:py-0 py-5 items-start md:items-center flex-col md:flex-row container ">
        ...
        <div className="md:hidden block">
            <button onClick={() => setShowNav(!isShowNav)} className="text-2xl bg-[#75D5E3]">
        ...
        <div className="flex-none">
          <ul
            className={`menu md:static   py-8 md:py-4 md:w-auto w-1/2 h-screen md:h-auto absolute z-50 top-20  items-center duration-300 md:menu-horizontal px-1 ${
              Dark ? "text-white bg-[#1D232A]" : "text-slate-800 bg-white"
